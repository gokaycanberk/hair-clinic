          ...
          <div className="lg:w-1/2 p-12 lg:p-16 flex flex-col justify-center">
            <div className="max-w-lg">
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                ...
                interest-free plans and longer-term monthly payment options. You
                can begin treatment now and pay over time — without the
                financial stress.
              </p>
              ...
              <div className="space-y-6">
                ...
                <button className="w-full bg-golden text-white px-8 py-4 rounded-lg font-medium hover:bg-golden/90 transition-colors shadow-lg hover:shadow-xl">
